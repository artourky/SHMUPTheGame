...
BasicGame.Preloader.prototype = {
  ...
  preload: function () {
    ...
    this.load.spritesheet('greenerEnemy', 'assets/enemy edit.png', 32, 32);
    this.load.spritesheet('whiterEnemy', 'assets/shooting-enemy edit.png', 32, 32);
    this.load.image('powerup1', 'assets/powerup1.png');
    this.load.image('enemyBullet', 'assets/enemy-bullet.png');
    this.load.image('enemyBullet2', 'assets/enemy-bullet 2.png');
    this.load.spritesheet('boss', 'assets/boss.png', 93, 75);
    this.load.spritesheet('explosion', 'assets/explosion.png', 32, 32);
    this.load.spritesheet('player', 'assets/player.png', 64, 64);
    this.load.spritesheet('player2', 'assets/player 2.png', 64, 64);
